#
#  Be sure to run `pod spec lint SeelKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "CP"
  # spec.authors            = { "CP" => "1020324999@qq.com" }
  # spec.social_media_url   = "https://twitter.com/CP"
